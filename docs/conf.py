"""Sphinx configuration for pspec_likelihood documentation."""
import os
import sys
import time
...
copyright = f"{time.localtime()[0]}, HERA-Team"
...
latex_documents = [
    ("index", "pspec_likelihood.tex", "pspec_likelihood Documentation", "HERA-Team", "manual"),
]
...
man_pages = [("index", "pspec_likelihood", "pspec_likelihood Documentation", ["HERA-Team"], 1)]
